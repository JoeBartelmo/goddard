...
class DaqTelemetry
{
  public:
   ...
   double outputFrontDistance; //computed distance from the object in front
   double outputBackDistance; //computed distance from the object in back
};
 ...
 */
DaqTelemetry* daq(double outputFrontDistance, double outputBackDistance)
{ 
  ...
  //Copy over
  telemetry->outputFrontDistance = outputFrontDistance;
  telemetry->outputBackDistance = outputBackDistance;
...
void save_and_send(DaqTelemetry *daqTelemetry)
{
    String daqString = String(daqTelemetry->systemRpm) + "," + 
                ...
                String(daqTelemetry->outputFrontDistance) + "," +
                String(daqTelemetry->outputBackDistance);
