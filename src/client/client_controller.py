...
class MasterControl(tk.Frame):
    def __init__(self, parent, streams):
        ...
        self.move_forward = tk.Button(self, text='>>', command=self.move_fwd)
        self.move_back = tk.Button(self, text='<<', command=self.move_bkwd)
        self.snap_current = tk.Button(self, text='|>', command=self.snap_current)
        self.snap_start = tk.Button(self, text='<|', command=self.move_start)
        self.quit_button = tk.Button(self, text='x', command=self.quit)
